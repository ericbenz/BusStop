    ...
    func getDestination(destination : String) {
        ...
        geocoder.geocodeAddressString(destination, completionHandler: {(placemarks, error) -> Void in
            if let placemark = placemarks?.first {
                ...
                let GoogURL = "https://maps.googleapis.com/maps/api/directions/json?origin=" + startlat + "," + startlon + "+&destination=" + endlat + "," + endlon + "&mode=transit&arrival_time=1391374800&key=AIzaSyAin3j3P5jwRY6fPdPbMTfeqLU_jHwWWG0"
